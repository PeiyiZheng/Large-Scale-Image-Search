...
caffe_root = '/Users/Peiyi/Documents/Computer Vision/final/caffe/'

# Model prototxt file
model_prototxt = caffe_root + 'models/resnet/ResNet-152-deploy.prototxt'

# Model caffemodel file
model_trained = caffe_root + 'models/resnet/ResNet-152-model.caffemodel'
